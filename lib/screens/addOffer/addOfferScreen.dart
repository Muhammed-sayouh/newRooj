...
class _AddOfferScreenState extends State<AddOfferScreen> {
  ...
  Widget supCategoryWidget(BuildContext context, List<Datum> homeItem) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return InkWell(
          onTap: () {
            setState(() {
              subCategory = homeItem[index].name;
              subCategoryId = homeItem[index].id.toString();
            });
            Navigator.pop(context);
          },
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Offstage(
                    offstage:
                        subCategory == homeItem[index].name ? false : true,
                    child:
                        Icon(Icons.check_circle, color: AppColors.mainColor)),
                // SizedBox(width: 10),
                Expanded(
